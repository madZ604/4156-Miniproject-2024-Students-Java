...
public class RouteController {
  ...
  public ResponseEntity<?> retrieveDepartment(@RequestParam("deptCode") String deptCode) {
    try {
      ...
      if (!departmentMapping.containsKey(deptCode.toUpperCase(new Locale("en", "US")))) {
        return new ResponseEntity<>("Department Not Found", HttpStatus.NOT_FOUND);
      } else {
        return new ResponseEntity<>(departmentMapping.get(deptCode.toUpperCase(
            new Locale("en", "US"))).toString(), HttpStatus.OK);
      }
  ...
  public ResponseEntity<?> isCourseFull(@RequestParam("deptCode")
      String deptCode, @RequestParam("courseCode") int courseCode) {
    try {
  ...
  public ResponseEntity<?> findCourseInstructor(@RequestParam("deptCode")
      String deptCode, @RequestParam("courseCode") int courseCode) {
    try {
      boolean doesCourseExists;
      doesCourseExists = retrieveCourse(deptCode, courseCode).getStatusCode() == HttpStatus.OK;
  ...
  public ResponseEntity<?> setEnrollmentCount(@RequestParam("deptCode") String deptCode,
      @RequestParam("courseCode") int courseCode, @RequestParam("count")
      int count) {
    try {
      boolean doesCourseExists;
      doesCourseExists = retrieveCourse(deptCode, courseCode).getStatusCode() == HttpStatus.OK;
  ...
  public ResponseEntity<?> changeCourseTime(@RequestParam("deptCode") String deptCode,
      @RequestParam("courseCode") int courseCode, @RequestParam("time")
      String time) {
    try {
      boolean doesCourseExists;
      doesCourseExists = retrieveCourse(deptCode, courseCode).getStatusCode() == HttpStatus.OK;
  ...
  public ResponseEntity<?> changeCourseTeacher(@RequestParam("deptCode") String deptCode,
      @RequestParam("courseCode") int courseCode, @RequestParam("teacher")
      String teacher) {
    try {
      boolean doesCourseExists;
      doesCourseExists = retrieveCourse(deptCode, courseCode).getStatusCode() == HttpStatus.OK;
  ...
  */
  ...
  public ResponseEntity<?> changeCourseLocation(@RequestParam("deptCode") String deptCode,
      @RequestParam("courseCode")int courseCode, @RequestParam("location")
      String location) {
    try {
      boolean doesCourseExists;
      doesCourseExists = retrieveCourse(deptCode, courseCode).getStatusCode() == HttpStatus.OK;
